...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3331677384030929308L;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createAt, com.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCreateAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCreateAt() {
