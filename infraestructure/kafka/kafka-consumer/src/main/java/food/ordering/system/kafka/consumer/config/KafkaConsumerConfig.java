package food.ordering.system.kafka.consumer.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase>{
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(kafkaConsumerConfigData.getSpecificAvoReaderKey(), kafkaConsumerConfigData.getSpecificAvoReader());
        ...
        props.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, kafkaConsumerConfigData.getMaxPartitionFetchBytesDefault() * kafkaConsumerConfigData.getMaxPartitionFetchBytesBootsFactor());
